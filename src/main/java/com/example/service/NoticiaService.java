...
public interface NoticiaService {
    ...
    publicacion actualizarNoticia(Integer id, String titulo, String contenido, String categoria, byte[] archivoAdjunto, String urlPublicacion, Date fechPublicacion, Integer idAdmin);
